<div class="d-grid gap-2 col-6 mx-auto">
    ...
    ?>
            ...
            <a href="index.php?uc=rapports&action=formulaireHistorique" type="button" class="btn btn-primary btn-lg">
                Consulter l'historique des rapports de visite de la région
            </a>
    <?php
        }
    }
