        ...
        <div class="row align-items-center justify-content-center">
            ...
            <div class="test col-12 col-sm-8 col-lg-6 col-xl-5 col-xxl-4 py-lg-5 py-3">
                <div class="formulaire">
                    ...
                    <p><span class="carac">Nom du praticien</span> : <a href='index.php?uc=praticiens&action=afficherpratic&praticien=<?= $rapport['PRA_NOM'] ?>'><?php echo $rapport['PRA_NOM'] ?><a></p>
                    ...
                    <p><span class="carac">Nom du medicament 1</span> : <a href='index.php?uc=medicaments&action=affichermedoc&medicament=<?= $rapport['MED_DEPOTLEGAL_1'] ?>' ><?php echo $rapport['nomMed1'] ?><a></p>
                    <p><span class="carac">Code medicament 2</span> : <?php echo $rapport['MED_DEPOTLEGAL_2'] ?></p>
                    <p><span class="carac">Nom du medicament 2</span> : <a href='index.php?uc=medicaments&action=affichermedoc&medicament=<?= $rapport['MED_DEPOTLEGAL_2'] ?>' ><?php echo $rapport['nomMed2'] ?><a></p>
                </div>
            </div>
            <?php
            }
